...
export default async function OptionsMarketReadPage() {
  ...
  return (
    <div className={styles.page}>
      <header className={styles.header}>
        ...
        <nav aria-label="Options Market Read">
          <span className={styles.environmentBadge}>
            {isStaging ? "Testing environment" : "Public preview"}
          </span>
      ...
      <footer className={styles.footer}>
        <span>
          {isStaging ? "Isolated staging" : "Public preview"} · BTC only · deterministic output
        </span>
