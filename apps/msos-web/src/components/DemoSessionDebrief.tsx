    ...
    >
      ...
      {submitState === "sent" ? (
        <p className="feedback-success" role="status">
          Feedback saved. You can still copy the validation row below if you want it in{" "}
      ...
      <p className="micro">
        ...
        <code>python scripts/ppe_export_web_feedback.py --markdown</code>. See{" "}
        <Link href={MSOS_ROUTES.strategyLab}>Strategy Lab</Link> to replay the tour.
      </p>
    </section>
  );
}
