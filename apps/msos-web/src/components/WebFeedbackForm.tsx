...
export type WebFeedbackFormProps = {
  ...
  /** Optional prefill for operator debrief reuse. */
...
export function WebFeedbackForm({
  ...
  const handleSubmit = useCallback(async () => {
    ...
    if (initialComprehension) {
      payload.comprehension = initialComprehension;
    }
    if (initialReturnIntent) {
      payload.return_intent = initialReturnIntent;
    }
