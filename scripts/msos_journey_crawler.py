...
Usage:
  python scripts/msos_journey_crawler.py --base-url http://localhost:3000
  python scripts/msos_journey_crawler.py --base-url https://marketstructureos.com --flows routes missing-paper
  python scripts/msos_journey_crawler.py --base-url http://localhost:3000 --flows delete-paper
...
# Static MSOS routes — keep in sync with tests/test_msos_web_e2e_product_witness.py
