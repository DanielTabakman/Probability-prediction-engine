...
def format_markdown(records: list[dict], *, source_path: Path) -> str:
    ...
    lines.append(
        "| When (UTC) | Source | Profile | Comprehension | Return | Category | Use | Repeat | Notes |"
    )
    lines.append("| --- | --- | --- | --- | --- | --- | --- | --- | --- |")
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Path to ppe_web_feedback.jsonl (default: PPE_WEB_FEEDBACK_DIR or apps/msos-web/data/)",
    )
    parser.add_argument(
        "--markdown",
        action="store_true",
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Write markdown to this file (implies --markdown)",
    )
