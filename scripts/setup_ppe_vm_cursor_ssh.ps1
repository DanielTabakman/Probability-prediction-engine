...
Write-Host ""
Write-Host "Optional (desktop operator env): add to ppe_operator_no_loop.local.cmd:"
Write-Host "  set PPE_VM_SSH_HOST=ppe-vm"
Write-Host ""
Write-Host "Verify VM mirror after merge: scripts\vm_verify_mirror.cmd"
