...
- *(empty — Slice004 closed via CONTROL-CLOSEOUT 2026-04-28.)*
...
- **`Sprint004-Slice004` + `WH-Slice-004` — Directional-disagreement candidate strip + payload/harness refactor (v0)** — **CLOSED / shipped** (2026-04-28 CONTROL-CLOSEOUT; promoted baseline tip **`31ff3df2f5ed9adb30a54e4ff7f58b2052f60332`**).
...
- **`Sprint004-Slice004` + `WH-Slice-004` — Directional-disagreement candidate strip + payload/harness refactor (v0)** — **CLOSED / shipped** (2026-04-28 CONTROL-CLOSEOUT; promoted baseline tip **`31ff3df2f5ed9adb30a54e4ff7f58b2052f60332`**). Evidence on promoted baseline: pytest **127** passed; UI smoke **PASS** (`schema_version: 3`; `evidence_plane_complete: true`).
- **`WH-Slice-005` — Protocol trial lifecycle + trial ledger (v1)** — **CLOSED / shipped** (2026-04-28 CONTROL-CLOSEOUT; promoted baseline tip **`0415a6acfb8e238d326e933c541ac8436930aec9`**). Canonical docs: `docs/SOP/PROTOCOL_TRIAL_LIFECYCLE_V1.md`, `docs/SOP/PROTOCOL_TRIAL_LEDGER.md`.
