...
- **Next steward action:** IDE BUILD msos_self_serve_onboarding_v1 (workstream A) — run_ppe.cmd or IDE_BUILD_STARTER; parallel validation sessions per TRADER_WORKFLOW_RESEARCH_V1.md
