...
- **Active relay chapter:** `ppe_commodity_proxy_tier1_v1` · plan [`ppe_commodity_proxy_tier1_v1_relay.json`](docs/SOP/PHASE_PLANS/ppe_commodity_proxy_tier1_v1_relay.json)
- **Next steward action:** VM run_ppe.cmd on ppe_commodity_proxy_tier1_v1; finish gh auth setup-git on ppeloop for loop publish
