...
- **Active relay chapter:** `ppe_equity_universe_tier1a_v1` · plan [`ppe_equity_universe_tier1a_v1_relay.json`](docs/SOP/PHASE_PLANS/ppe_equity_universe_tier1a_v1_relay.json)
- **Next steward action:** VM loop continues ppe_equity_universe_tier1a_v1 relay (SPY QQQ IWM); desktop idle unless IDE_BUILD
