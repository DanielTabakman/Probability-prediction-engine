...
**Await steward SELECTION** — [`PPE_TRADEABLE_UNIVERSE_PROGRAM_V1.md`](docs/SOP/PPE_TRADEABLE_UNIVERSE_PROGRAM_V1.md). **Worry audit:** [`PPE_RISK_REGISTER.md`](PPE_RISK_REGISTER.md).
