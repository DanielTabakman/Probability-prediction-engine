...
flowchart LR
  ...
  subgraph nextBuild [Chartered]
    ON["MVP1 onboarding IN PROGRESS"]
  end
  closed2 --> closed3
  closed3 --> nextBuild
  nextBuild --> steward
...
| MVP1 onboarding / How it works | **IN PROGRESS** 2026-05-20 | [`SPRINT_MVP1_ONBOARDING_HOW_IT_WORKS.md`](SPRINT_MVP1_ONBOARDING_HOW_IT_WORKS.md), [`MVP1_ONBOARDING_HOW_IT_WORKS_EVIDENCE_STATUS.md`](MVP1_ONBOARDING_HOW_IT_WORKS_EVIDENCE_STATUS.md) |
