...
flowchart LR
  ...
  subgraph closed3 [Also closed]
    ...
    DS[MVP1 disagreement strip polish COMPLETE]
  end
  closed2 --> closed3
  closed3 --> steward
```
...
| MVP1 disagreement / candidate strip polish | **COMPLETE** 2026-05-20 | [`SPRINT_MVP1_DISAGREEMENT_CANDIDATE_STRIP_POLISH.md`](SPRINT_MVP1_DISAGREEMENT_CANDIDATE_STRIP_POLISH.md), [`MVP1_DISAGREEMENT_CANDIDATE_STRIP_POLISH_EVIDENCE_STATUS.md`](MVP1_DISAGREEMENT_CANDIDATE_STRIP_POLISH_EVIDENCE_STATUS.md) |
