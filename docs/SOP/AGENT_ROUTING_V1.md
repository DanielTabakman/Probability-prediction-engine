...
**Thread openers:** [`THREAD_STARTERS_V1.md`](THREAD_STARTERS_V1.md) · rules: [`.cursor/rules/ppe-roles.mdc`](../../.cursor/rules/ppe-roles.mdc) · context: [`AGENT_CONTEXT_RULES_V1.md`](AGENT_CONTEXT_RULES_V1.md)
...
Charter/explore/neutral: do **not** end replies with relay verdicts, stash pop, or checkout instructions unless the user asked about git/queue. See [`.cursor/rules/ppe-roles.mdc`](../../.cursor/rules/ppe-roles.mdc) § Response shape.

### Relay disclosure (when offering work)

When proposing implementation, fix, or ship work, state relay impact in one line — see [`.cursor/rules/ppe-roles.mdc`](../../.cursor/rules/ppe-roles.mdc) § Relay disclosure:
...
Thread roles: .cursor/rules/ppe-roles.mdc — no charter-style response tails.
