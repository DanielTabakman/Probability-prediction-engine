...
| MVP1-DisagreementStrip-Smoke-Slice003 | pending | dual smoke run IDs: TBD |
...
| Gate | Status | Notes |
|------|--------|-------|
| `python -m pytest -q` | **PASS** | **186** passed (2026-05-26) |
| Dual smoke | pending | record on Smoke-Slice003 |

---

## Dual smoke

- Run IDs: *(record on Smoke-Slice003)*

## Pytest

- Count at closeout: TBD
