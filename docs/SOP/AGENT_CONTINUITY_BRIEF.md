...
**Steward note:** Refreshed for **disagreement strip polish chapter close** (2026-05-20); next successful `apply_control_closeout_v1` run will overwrite per automation rules.

**As-of:** 2026-05-20T05:15:00Z · **HEAD:** verify after merge · **Closeout slice:** `MVP1-DisagreementStrip-Closeout-Slice004`
...
3. Carry docs: [`POST_MVP1_ONBOARDING_HOW_IT_WORKS_SELECTION.md`](POST_MVP1_ONBOARDING_HOW_IT_WORKS_SELECTION.md), [`MVP1_DISAGREEMENT_CANDIDATE_STRIP_POLISH_EVIDENCE_STATUS.md`](MVP1_DISAGREEMENT_CANDIDATE_STRIP_POLISH_EVIDENCE_STATUS.md).
