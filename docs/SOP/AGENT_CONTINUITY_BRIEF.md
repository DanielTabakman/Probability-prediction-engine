...
**As-of:** 2026-06-25 · **Milestone:** Trader Workflow Integration v1 · **Active relay:** `ppe_crypto_multi_asset_v1`
...
| Field | Value |
|-------|-------|
| Chapter | Trader Workflow Integration v1 (milestone) |
| Status | **IN PROGRESS** |
| Charter | [MILESTONE_TRADER_WORKFLOW_INTEGRATION_V1.md](docs/SOP/MILESTONE_TRADER_WORKFLOW_INTEGRATION_V1.md) |
| Active relay | `ppe_crypto_multi_asset_v1` (workstream B) |
| Foundation | Usable demo **COMPLETE** 2026-06-25 |
