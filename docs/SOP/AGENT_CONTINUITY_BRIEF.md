...
**Active relay:** `ppe_equity_options_v1` — Trader workflow integration — MSOS used as part of the trading process, not a one-off demo

- **Sprint:** [`SPRINT_PPE_EQUITY_OPTIONS_V1.md`](docs/SOP/SPRINT_PPE_EQUITY_OPTIONS_V1.md)
- **Plan:** [`ppe_equity_options_v1_relay.json`](docs/SOP/PHASE_PLANS/ppe_equity_options_v1_relay.json)
