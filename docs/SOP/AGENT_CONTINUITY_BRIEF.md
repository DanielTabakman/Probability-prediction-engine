...
**As-of:** 2026-07-11T18:44:51Z · **HEAD:** `4b3bc65be08c31138f7274b51ed89234401d5653` · **Closeout slice:** `PPE-HyperliquidPerp-Closeout-Slice005`
...
| Field | Value |
|-------|-------|
| Chapter | PPE Hyperliquid perp rail v1 (HYPE exposure path) |
| Status | COMPLETE |
| Closed | 2026-07-11 |
| Evidence | [PPE_HYPERLIQUID_PERP_RAIL_V1_EVIDENCE_STATUS.md](docs/SOP/PPE_HYPERLIQUID_PERP_RAIL_V1_EVIDENCE_STATUS.md) |
| Next SELECTION | [PPE_HYPERLIQUID_PERP_RAIL_PROGRAM_V1.md](docs/SOP/PPE_HYPERLIQUID_PERP_RAIL_PROGRAM_V1.md) |
...
- **relay_run_dir:** `C:/Users/ppeloop/Probability-prediction-engine/_worktrees/orchestrator/PPE-HyperliquidPerp-Closeout-Slice005-hyperliquid_perp/artifacts/relay/runs/20260711_182733`

## Doc load bundle

- `docs/SOP/POST_PPE_HYPERLIQUID_PERP_RAIL_V1_SELECTION.md`
- `docs/SOP/SPRINT_PPE_HYPERLIQUID_PERP_RAIL_V1.md`
- `docs/SOP/PPE_HYPERLIQUID_PERP_RAIL_V1_EVIDENCE_STATUS.md`
- `docs/SOP/PPE_HYPERLIQUID_PERP_RAIL_PROGRAM_V1.md`
...
3. Carry docs: `docs/SOP/POST_PPE_HYPERLIQUID_PERP_RAIL_V1_SELECTION.md`, `docs/SOP/SPRINT_PPE_HYPERLIQUID_PERP_RAIL_V1.md`, `docs/SOP/PPE_HYPERLIQUID_PERP_RAIL_V1_EVIDENCE_STATUS.md`, `docs/SOP/PPE_HYPERLIQUID_PERP_RAIL_PROGRAM_V1.md`.
