...
**Active relay:** `ppe_asset_display_parity_v1` — Trader workflow integration — MSOS used as part of the trading process, not a one-off demo

- **Sprint:** [`SPRINT_PPE_ASSET_DISPLAY_PARITY_V1.md`](docs/SOP/SPRINT_PPE_ASSET_DISPLAY_PARITY_V1.md)
- **Plan:** [`ppe_asset_display_parity_v1_relay.json`](docs/SOP/PHASE_PLANS/ppe_asset_display_parity_v1_relay.json)
