...
**Active relay:** `ppe_commodity_proxy_tier1_v1` — Trader workflow integration — MSOS used as part of the trading process, not a one-off demo

- **Sprint:** [`SPRINT_PPE_COMMODITY_PROXY_TIER1_V1.md`](docs/SOP/SPRINT_PPE_COMMODITY_PROXY_TIER1_V1.md)
- **Plan:** [`ppe_commodity_proxy_tier1_v1_relay.json`](docs/SOP/PHASE_PLANS/ppe_commodity_proxy_tier1_v1_relay.json)
