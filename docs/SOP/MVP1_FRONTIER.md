...
- **Active BUILD chapter:** **none** — await steward **SELECTION** ([`FORWARD_CONSISTENCY_RADAR_PROGRAM_V1.md`](docs/SOP/FORWARD_CONSISTENCY_RADAR_PROGRAM_V1.md))
- **Last closed chapter:** **MSOS forward consistency radar v1** — **COMPLETE** 2026-07-09
