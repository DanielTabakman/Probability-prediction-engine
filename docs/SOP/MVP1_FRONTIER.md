...
- **Active BUILD chapter:** **none** — await steward **SELECTION** ([`POST_MVP1_CROSS_VENUE_BACKTEST_V1_SELECTION.md`](docs/SOP/POST_MVP1_CROSS_VENUE_BACKTEST_V1_SELECTION.md))
- **Last closed chapter:** **MVP1 cross-venue scan v1** — **COMPLETE** 2026-07-08
