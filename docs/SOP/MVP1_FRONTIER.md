...
- **Active BUILD chapter:** **none** — await steward **SELECTION** ([`POST_MSOS_PRODUCTION_MULTI_ASSET_WITNESS_V1_SELECTION.md`](docs/SOP/POST_MSOS_PRODUCTION_MULTI_ASSET_WITNESS_V1_SELECTION.md))
- **Last closed chapter:** **PPE trust surface v1** — **COMPLETE** 2026-06-28
