...
- **Active BUILD chapter:** **none** — await steward **SELECTION** ([`POST_PPE_ASSET_ENABLEMENT_PIPELINE_V1_SELECTION.md`](docs/SOP/POST_PPE_ASSET_ENABLEMENT_PIPELINE_V1_SELECTION.md))
- **Last closed chapter:** **MVP1 cross-venue backtest v1** — **COMPLETE** 2026-07-09
