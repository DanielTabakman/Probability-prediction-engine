...
- **Active BUILD chapter:** **MVP1 post-Phase3 steering + smoke witness refresh (v0)** — **IN PROGRESS** ([`POST_PHASE3_COMMERCIAL_WRAPPER_SELECTION_OUTCOME.md`](POST_PHASE3_COMMERCIAL_WRAPPER_SELECTION_OUTCOME.md))
- **Last closed chapter:** **Phase 3 commercial wrapper (v0)** — **COMPLETE** 2026-05-28
