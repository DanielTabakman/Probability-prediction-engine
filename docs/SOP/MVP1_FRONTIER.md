...
- **Active BUILD chapter:** **none** — await steward **SELECTION** ([`MVP1_CROSS_VENUE_QUANT_PROGRAM_V1.md`](docs/SOP/MVP1_CROSS_VENUE_QUANT_PROGRAM_V1.md))
- **Last closed chapter:** **MVP1 cross-venue probability panel** — **COMPLETE** 2026-06-13
