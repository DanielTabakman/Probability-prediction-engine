...
- **Active BUILD chapter:** **none** — await steward **SELECTION** ([`PPE_MODULE_REGISTRY_V1.md`](docs/SOP/PPE_MODULE_REGISTRY_V1.md))
- **Last closed chapter:** **PPE Exposure menu v1** — **COMPLETE** 2026-06-29
