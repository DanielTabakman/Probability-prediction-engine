...
- **Active BUILD chapter:** **none** — await steward **SELECTION** ([`POST_PPE_DERIBIT_CRYPTO_TIER1_V1_SELECTION.md`](docs/SOP/POST_PPE_DERIBIT_CRYPTO_TIER1_V1_SELECTION.md))
- **Last closed chapter:** **PPE tradeable universe v1 (infrastructure)** — **COMPLETE** 2026-07-03
