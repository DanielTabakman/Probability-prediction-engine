...
- **Active BUILD chapter:** **none** — await steward **SELECTION** ([`POST_PPE_TRUST_SURFACE_V1_SELECTION.md`](docs/SOP/POST_PPE_TRUST_SURFACE_V1_SELECTION.md))
- **Last closed chapter:** **MSOS workflow asset parity v1** — **COMPLETE** 2026-06-28
