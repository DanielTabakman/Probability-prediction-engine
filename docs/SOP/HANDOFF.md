...
- Active MVP1 focus: **MVP1 onboarding / How it works (v0)** — **IN PROGRESS**; Control-Slice001 **CLOSED** 2026-05-20; belief-input UX **COMPLETE** 2026-05-20
- Closed chapters: … friends-first screen, belief-input UX (see `MVP1_FRONTIER.md`)
- Next pending execution step: **`MVP1-OnboardingHowItWorks-Product-Slice002`** (PRODUCT) — see `docs/SOP/SPRINT_MVP1_ONBOARDING_HOW_IT_WORKS.md` + `docs/SOP/MVP1_ONBOARDING_HOW_IT_WORKS_EVIDENCE_STATUS.md`
- Steward parallel: VPS `.env` CTA **pending**; verify VPS @ **`2c0393e`**+ after deploy; paid-interest **N**
...
- Baseline SHA: **`2c0393e`**+ (`git rev-parse origin/main`)
...
**`main` @ `2c0393e`** — MVP1 **onboarding / How it works**: **Control-Slice001** closed 2026-05-20. **Next:** `MVP1-OnboardingHowItWorks-Product-Slice002` (How it works UX).
...
2. **Steward:** VPS `.env` CTA + browser verify → [`VALIDATION_DEPLOY_WITNESS.md`](VALIDATION_DEPLOY_WITNESS.md); confirm `git rev-parse HEAD` ≥ `2c0393e`.
...
2026-05-20 — `MVP1-OnboardingHowItWorks-Control-Slice001` closed (charter witness); **next** Product-Slice002; handoff synced.
