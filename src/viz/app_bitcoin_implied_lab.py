"""
Bitcoin implied lab page (Streamlit layout).

Extracted from app.py so the shell stays thin; see docs/SOP/VIZ_LAYER_DISCIPLINE_V1.md.
"""
...
def render_bitcoin_implied_lab_page(
    *,
    root: Any,
    config: dict,
    btc_symbols: dict,
