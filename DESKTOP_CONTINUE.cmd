...
ssh %SSH_OPTS% %VM_HOST% "cd /d %VM_REPO% && call call_ppe_operator_local.cmd && set PYTHONPATH=%VM_REPO% && python scripts/ppe_operator_git_sync.py --prepare-handoff-auto && finish_ide_build.cmd"
set "RC=%ERRORLEVEL%"
