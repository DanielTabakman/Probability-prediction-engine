...
RB_ID = "region_bet_payoff_save_v1"
...
RB_PLAN = "docs/SOP/PHASE_PLANS/region_bet_payoff_save_v1_relay.json"
...
def test_ready_frontier_is_region_bet_payoff_save(monkeypatch) -> None:
...
def test_founder_portfolio_recommends_region_bet_payoff_save(monkeypatch) -> None:
    monkeypatch.delenv("MSOS_AUTOBUILDER_STATUS_ROOT", raising=False)
    ...
    assert work["selected_native_slice"] == "RegionBet-PayoffSave-Product-Slice002"
